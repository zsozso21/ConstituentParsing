...
public class ProductParser implements Runnable {
	...
	private CoarseToFineNBestParser parser;
	protected static String sentence;
	public static int kbest = 50;
	public static boolean skipParsingErrors = false;
	private static double EPS = -500f; 
	private List<Parse> parses;
	private static List<ProductParser> threads;
	...
	public static Parse parse(String _sentence) {
		return parseNBest(_sentence, 1).get(0);
	}
	
	public static List<Parse> parseNBest(String _sentence, int n) {
		sentence = _sentence;
	...
	public static void parseFile(String in, String out, int kbest) throws IOException{
