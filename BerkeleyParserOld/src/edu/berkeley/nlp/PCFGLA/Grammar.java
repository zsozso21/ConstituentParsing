...
//		this(nSubStates,findClosedPaths,smoother,oldGrammar,thresh, Numberer.getGlobalNumberer("tags"));
//		if(oldGrammar!=null)
//			this.tagNumberer=oldGrammar.tagNumberer;
//	}
	
	public Grammar(short[] nSubStates, boolean findClosedPaths,
			 Smoother smoother, Grammar oldGrammar, double thresh, Numberer tagnum) {
		this.tagNumberer = tagnum;
	...
	public void optimize(double randomness, Random random) {
...
//			}
	 ...
	 * @return
	 */
	public Grammar splitAllStates(double randomness, int[] counts, boolean moreSubstatesThanCounts, int mode, Random random) {
		if (logarithmMode) {
...
//			}
		...
		Grammar grammar = new Grammar(newNumSubStates, findClosedPaths, smoother, this, threshold, tagNumberer);
...
//						System.out.println(substate+" "+mapping[state].length+" "+state);
