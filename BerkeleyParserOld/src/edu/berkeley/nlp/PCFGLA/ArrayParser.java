 ...
 */
public class ArrayParser implements Parser, Serializable {
  private static final long serialVersionUID = 5880384052306110329L;
	// i dont know how to initialize shorts...
  short zero = 0, one = 1;
  protected Numberer tagNumberer = null;
  ...
  public ArrayParser(Grammar gr, Lexicon lex) {
    ...
    this.grammar = gr;
    this.lexicon = lex;
    this.tagNumberer = gr.tagNumberer;
