...
//  int sentencesParsed;
  ...
  public CoarseToFineMaxRuleParser(Grammar gr, Lexicon lex, Map num, double unaryPenalty, int endL, 
    ...
    this.tagNumberer = (Numberer)num.get("tags");
    this.wordNumberer = (Numberer)num.get("words");
  	grammar=gr;
	lexicon=lex;
  ...
  public CoarseToFineMaxRuleParser(Grammar gr, Lexicon lex, double unaryPenalty, int endL, 
  		boolean viterbi, boolean sub, boolean score, boolean accurate, boolean variational,
  		boolean useGoldPOS, boolean initializeCascade) {
  	this(gr,lex,Numberer.getNumberers(), unaryPenalty,endL,viterbi,sub,score,accurate,variational,useGoldPOS,initializeCascade);
  }
  
	public Numberer getWordNumberer() {
  	return wordNumberer;
  }
...
//  		System.out.print(parse+". NoPruning: " +totalStates + ". Before: "+previouslyPossible+". After: "+nowPossible+".\n");
	  ...
	  public void doPreParses(List<String> sentence, Tree<StateSet> tree,boolean noSmoothing,List<String> posTags){
	  	...
	  	double[] accurateThresholds =  {-8,-12,-12,-11,-12,-12,-14,-15,-16,-17};
	  	double[] fastThresholds =  {-8,-9.75,-10,-9.6,-9.66,-8.01,-7.4,-10,-11,-12,-12};
