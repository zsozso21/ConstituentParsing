...
public class CoarseToFineNBestParser extends CoarseToFineMaxRuleParser{
	 ...
	 * @param useGoldPOS
	 */
	public CoarseToFineNBestParser(Grammar gr, Lexicon lex, Map numberers, int k, double unaryPenalty, int endL, boolean viterbi, 
			boolean sub, boolean score, boolean accurate, boolean variational, boolean useGoldPOS, boolean initCascade) {
		super(gr, lex, numberers, unaryPenalty, endL, viterbi, sub, score, accurate, variational,useGoldPOS, initCascade);
		this.k = k;
	}

	public CoarseToFineNBestParser(Grammar gr, Lexicon lex, int k, double unaryPenalty, int endL, boolean viterbi, 
			boolean sub, boolean score, boolean accurate, boolean variational, boolean useGoldPOS, boolean initCascade) {
		super(gr, lex, Numberer.getNumberers(),unaryPenalty, endL, viterbi, sub, score, accurate, variational,useGoldPOS, initCascade);
		this.k = k;
	}
...
//				System.out.println("Scale: "+iScale[0][length][0]);
  ...
  public String toString(){
  	return grammar.getNumberOfRules() +","+ grammar.numStates +","+ ((SophisticatedLexicon)lexicon).totalTokens +","+  ((SophisticatedLexicon)lexicon).totalUnseenTokens
  	       +","+ grammarCascade.length +","+ numStates +","+ maxNSubStates +","+ numSubStatesArray.length +","+ grammarTags.length +","+  wordNumberer.getNumberers().size() +","+  tagNumberer.getNumberers().size();
  }
