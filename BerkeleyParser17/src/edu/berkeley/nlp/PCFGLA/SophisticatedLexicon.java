...
public class SophisticatedLexicon implements java.io.Serializable, Lexicon {
	...
	@SuppressWarnings("unchecked")
	public SophisticatedLexicon(int uwm, short[] numSubStates, int smoothingCutoff,
			double[] smoothParam, Smoother smoother, double threshold) {
		this.unknownLevel = uwm;
		this.numSubStates = numSubStates;
		this.smoothingCutoff = smoothingCutoff;
		this.smooth = smoothParam;
		this.smoother = smoother;
	...
	public SophisticatedLexicon splitAllStates(int[] counts,
		...
		/*SophisticatedLexicon lexicon = new SophisticatedLexicon(
				...
				this.threshold);*/
		SophisticatedLexicon lexicon = new LatticeLexicon(unknownLevel, newNumSubStates, this.smoothingCutoff, smooth, smoother, this.threshold, this.wordNumberer);
	...
	public SophisticatedLexicon projectLexicon(double[] condProbs,
		...
		SophisticatedLexicon newLexicon = new LatticeLexicon(unknownLevel, newNumSubStates, this.smoothingCutoff, this.smooth, newSmoother, this.threshold, this.wordNumberer);
	...
	public SophisticatedLexicon copyLexicon() {
		...
		SophisticatedLexicon newLexicon = new LatticeLexicon(unknownLevel, newNumSubStates, this.smoothingCutoff, this.smooth, this.smoother, this.threshold, this.wordNumberer);
